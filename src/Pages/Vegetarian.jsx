...
import BannerImg from '../assets/img/vegetarian/banner.jpg'

import Gallery1 from '../assets/img/vegetarian/gallery1.jpg'
import Gallery2 from '../assets/img/vegetarian/gallery2.jpg'
import Gallery3 from '../assets/img/vegetarian/gallery3.jpg'
import Gallery4 from '../assets/img/vegetarian/gallery4.jpg'
import Gallery5 from '../assets/img/vegetarian/gallery5.jpg'
...
export default class Vegetarian extends Component {
    render() {
        this.state = {
            ...
            BannerSection: [
                BannerImg,
                "Touch Deeply on 'Vegetables'",
                "We want the whole world to feel the true essence of Vegetables"
            ],
            GallerySection: [
                Gallery1,
                Gallery2,
