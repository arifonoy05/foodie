...
import BannerImg from '../assets/img/chinese_cuisine/banner.jpg'

import Gallery1 from '../assets/img/chinese_cuisine/gallery1.jpg'
import Gallery2 from '../assets/img/chinese_cuisine/gallery2.jpg'
import Gallery3 from '../assets/img/chinese_cuisine/gallery3.jpg'
import Gallery4 from '../assets/img/chinese_cuisine/gallery4.jpg'
import Gallery5 from '../assets/img/chinese_cuisine/gallery5.jpg'
...
export default class ChineseCuisine extends Component {
    render() {
        this.state = {
            navlogo : logo,
            BannerSection: [
                BannerImg,
                "Touch Deeply on 'Chinese Cuisine'",
                "We want the whole world to feel the true essence of Chinese cuisine"
            ],
            GallerySection: [
                Gallery1,
                Gallery2,
