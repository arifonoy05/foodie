...
import BannerImg from '../assets/img/fastfood/banner.jpg'

import Gallery1 from '../assets/img/fastfood/gallery1.jpg'
import Gallery2 from '../assets/img/fastfood/gallery2.jpg'
import Gallery3 from '../assets/img/fastfood/gallery3.jpg'
import Gallery4 from '../assets/img/fastfood/gallery4.jpg'
import Gallery5 from '../assets/img/fastfood/gallery5.jpg'
...
export default class FastFood extends Component {
    render() {
        this.state = {
            ...
            BannerSection: [
                BannerImg,
                "Touch Deeply on Gourmet Fastfood",
                "We want the whole world to feel the true essence of Gourmet Fastfood"
            ],
            GallerySection: [
                Gallery1,
                Gallery2,
